...
const CACHE = "sbc-terminal-v36";
const SHELL = ["./", "./index.html", "./app.js?v=36", "./charts.js", "./universe.js", "./data.js", "./sec.js", "./segments.js", "./sectors.js", "./estimates.js", "./scores.js", "./manifest.json", "./icon.svg"];
