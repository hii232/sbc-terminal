...
const CACHE = "sbc-terminal-v31";
const SHELL = ["./", "./index.html", "./app.js?v=31", "./charts.js", "./universe.js", "./data.js", "./sec.js", "./segments.js", "./sectors.js", "./estimates.js", "./scores.js", "./manifest.json", "./icon.svg"];
