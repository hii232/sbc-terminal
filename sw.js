...
const CACHE = "sbc-terminal-v32";
const SHELL = ["./", "./index.html", "./app.js?v=32", "./charts.js", "./universe.js", "./data.js", "./sec.js", "./segments.js", "./sectors.js", "./estimates.js", "./scores.js", "./manifest.json", "./icon.svg"];
