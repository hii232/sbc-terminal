...
const CACHE = "sbc-terminal-v29";
const SHELL = ["./", "./index.html", "./app.js?v=29", "./charts.js", "./universe.js", "./data.js", "./sec.js", "./segments.js", "./sectors.js", "./estimates.js", "./scores.js", "./manifest.json", "./icon.svg"];
