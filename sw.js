...
const CACHE = "sbc-terminal-v30";
const SHELL = ["./", "./index.html", "./app.js?v=30", "./charts.js", "./universe.js", "./data.js", "./sec.js", "./segments.js", "./sectors.js", "./estimates.js", "./scores.js", "./manifest.json", "./icon.svg"];
