...
const CACHE = "sbc-terminal-v28";
const SHELL = ["./", "./index.html", "./app.js", "./charts.js", "./universe.js", "./data.js", "./sec.js", "./segments.js", "./sectors.js", "./estimates.js", "./scores.js", "./manifest.json", "./icon.svg"];
