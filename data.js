...
const DATA = [
  ...
  co({ ticker:"AAPL", name:"Apple Inc.", sector:"Consumer Tech", bucket:"clean", grade:"A",
    price:310.31, change:-0.11, mktCap:4557.6, headlinePE:37.6, ownersKeep:0.94,
  ...
  co({ ticker:"MSFT", name:"Microsoft Corp.", sector:"Software", bucket:"clean", grade:"A",
    price:382.40, change:-1.66, mktCap:2840.6, headlinePE:22.8, ownersKeep:0.90,
  ...
  co({ ticker:"MU", name:"Micron Technology", sector:"Semis", bucket:"clean", grade:"A",
    price:920.20, change:-1.94, mktCap:1039.3, headlinePE:20.8, ownersKeep:0.92,
  ...
  co({ ticker:"CSCO", name:"Cisco Systems", sector:"Networking", bucket:"clean", grade:"A",
    price:112.67, change:0.79, mktCap:444.1, headlinePE:37.6, ownersKeep:0.91,
  ...
  co({ ticker:"TXN", name:"Texas Instruments", sector:"Semis", bucket:"clean", grade:"A",
    price:300.21, change:2.36, mktCap:273.2, headlinePE:51.4, ownersKeep:0.93,
  ...
  co({ ticker:"ADP", name:"Automatic Data Processing", sector:"HR Tech", bucket:"clean", grade:"A",
    price:242.50, change:-1.26, mktCap:96.9, headlinePE:22.6, ownersKeep:0.95,
  ...
  co({ ticker:"COST", name:"Costco Wholesale", sector:"Retail", bucket:"clean", grade:"A",
    price:960.98, change:1.42, mktCap:426.2, headlinePE:48.5, ownersKeep:0.97,
  ...
  co({ ticker:"GILD", name:"Gilead Sciences", sector:"Pharma", bucket:"clean", grade:"A",
    price:135.81, change:-0.40, mktCap:168.6, headlinePE:18.5, ownersKeep:0.90,
  ...
  co({ ticker:"HON", name:"Honeywell", sector:"Industrials", bucket:"clean", grade:"A",
    price:219.56, change:-2.44, mktCap:69.6, headlinePE:17.6, ownersKeep:0.93,
  ...
  co({ ticker:"ASML", name:"ASML Holding", sector:"Semi Equip", bucket:"clean", grade:"A",
    price:1740.60, change:-0.38, mktCap:670.9, headlinePE:58.9, ownersKeep:0.94,
  ...
  co({ ticker:"MELI", name:"MercadoLibre", sector:"E-commerce", bucket:"clean", grade:"B",
    price:1775.02, change:-2.13, mktCap:90.0, headlinePE:46.8, ownersKeep:0.88,
    ...
    buyback:[0.15,0.36,0.00,0.00], shares:[0.051,0.051,0.051,0.051],
  ...
  co({ ticker:"GOOGL", name:"Alphabet", sector:"Software", bucket:"middle", grade:"B",
    price:360.33, change:-1.83, mktCap:4397.0, headlinePE:27.5, ownersKeep:0.84,
  ...
  co({ ticker:"AMZN", name:"Amazon", sector:"E-commerce/Cloud", bucket:"middle", grade:"C",
    price:240.83, change:-2.10, mktCap:2590.6, headlinePE:31, ownersKeep:0.78,
  ...
  co({ ticker:"NVDA", name:"NVIDIA", sector:"Semis/AI", bucket:"middle", grade:"C",
    price:197.02, change:0.05, mktCap:4772.0, headlinePE:30.1, ownersKeep:0.83,
  ...
  co({ ticker:"AMD", name:"Advanced Micro Devices", sector:"Semis", bucket:"middle", grade:"D",
    price:502.70, change:-2.60, mktCap:819.7, headlinePE:168.1, ownersKeep:0.70,
  ...
  co({ ticker:"ADBE", name:"Adobe", sector:"Software", bucket:"middle", grade:"C",
    price:219.53, change:-0.91, mktCap:87.3, headlinePE:12.6, ownersKeep:0.80,
  ...
  co({ ticker:"NFLX", name:"Netflix", sector:"Streaming", bucket:"middle", grade:"B",
    price:75.82, change:-0.47, mktCap:319.3, headlinePE:24.5, ownersKeep:0.92,
  ...
  co({ ticker:"INTU", name:"Intuit", sector:"Software", bucket:"middle", grade:"C",
    price:271.44, change:-3.46, mktCap:74.2, headlinePE:16.6, ownersKeep:0.76,
  ...
  co({ ticker:"CDNS", name:"Cadence Design", sector:"EDA Software", bucket:"middle", grade:"C",
    price:366.59, change:-1.20, mktCap:101.1, headlinePE:85.3, ownersKeep:0.78,
  ...
  co({ ticker:"SNPS", name:"Synopsys", sector:"EDA Software", bucket:"middle", grade:"C",
    price:426.50, change:-2.32, mktCap:81.7, headlinePE:97.6, ownersKeep:0.77,
  ...
  co({ ticker:"AVGO", name:"Broadcom", sector:"Semis", bucket:"high", grade:"D",
    price:384.50, change:3.70, mktCap:1829.3, headlinePE:64, ownersKeep:0.68,
  ...
  co({ ticker:"LRCX", name:"Lam Research", sector:"Semi Equip", bucket:"high", grade:"D",
    price:326.07, change:-0.02, mktCap:407.8, headlinePE:61.8, ownersKeep:0.70,
  ...
  co({ ticker:"MPWR", name:"Monolithic Power", sector:"Semis", bucket:"high", grade:"D",
    price:1281.66, change:0.70, mktCap:63.0, headlinePE:91.5, ownersKeep:0.66,
    ...
    buyback:[0,0.00,0.64,0.01], shares:[0.048,0.049,0.049,0.048],
  ...
  co({ ticker:"APP", name:"AppLovin", sector:"AdTech", bucket:"high", grade:"D",
    price:509.00, change:-3.60, mktCap:171.0, headlinePE:44.2, ownersKeep:0.64,
  ...
  co({ ticker:"ARM", name:"Arm Holdings", sector:"Semis/IP", bucket:"high", grade:"F",
    price:291.82, change:-2.86, mktCap:311.7, headlinePE:347.4, ownersKeep:0.55,
  ...
  co({ ticker:"TSLA", name:"Tesla", sector:"Auto/AI", bucket:"tragic", grade:"D",
    price:392.83, change:-2.50, mktCap:1475.4, headlinePE:360.4, ownersKeep:0.72,
  ...
  co({ ticker:"PLTR", name:"Palantir", sector:"Software/AI", bucket:"tragic", grade:"F",
    price:128.24, change:-4.56, mktCap:307.4, headlinePE:144.1, ownersKeep:0.45,
  ...
  co({ ticker:"CRWD", name:"CrowdStrike", sector:"Cybersecurity", bucket:"tragic", grade:"F",
    price:186.51, change:-4.17, mktCap:189.9, headlinePE:null, ownersKeep:0.40,
  ...
  co({ ticker:"DDOG", name:"Datadog", sector:"Software", bucket:"tragic", grade:"F",
    price:254.03, change:-1.08, mktCap:90.4, headlinePE:651.4, ownersKeep:0.38,
  ...
  co({ ticker:"SHOP", name:"Shopify", sector:"E-commerce", bucket:"tragic", grade:"D",
    price:115.52, change:-5.22, mktCap:149.9, headlinePE:113.3, ownersKeep:0.55,
  ...
  co({ ticker:"MRVL", name:"Marvell Technology", sector:"Semis", bucket:"tragic", grade:"F",
    price:226.37, change:-1.88, mktCap:198.0, headlinePE:77.8, ownersKeep:0.42,
  ...
  co({ ticker:"ZS", name:"Zscaler", sector:"Cybersecurity", bucket:"tragic", grade:"F",
    price:142.40, change:-4.75, mktCap:23.0, headlinePE:null, ownersKeep:0.35,
  ...
  co({ ticker:"WDAY", name:"Workday", sector:"Software", bucket:"tragic", grade:"F",
    price:137.54, change:-4.25, mktCap:34.0, headlinePE:43, ownersKeep:0.40,
  ...
  co({ ticker:"AXON", name:"Axon Enterprise", sector:"Public Safety Tech", bucket:"tragic", grade:"D",
    price:596.98, change:-6.79, mktCap:48.1, headlinePE:238.8, ownersKeep:0.50,
    ...
    buyback:[0.00,0,0,0], shares:[0.073,0.075,0.079,0.082],
