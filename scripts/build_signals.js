...
const files = ["universe.js", "data.js", "sec.js", "segments.js", "sectors.js", "charts.js",
  "scores.js", "estimates.js", "earnings.js", "whales.js", "app.js"].filter(f => fs.existsSync(path.join(root, f)));
...
fs.writeFileSync(STATE_FILE, JSON.stringify({ date: today, tickers: stateNow, accessions: accSeen, filingsEmitted, estimates: estSeen, ratingsEmitted, whale13f, narratives: narrState }), "utf8");
