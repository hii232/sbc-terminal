...
def record(tk, meta, quote, f, fields):
    ...
    note = f"{meta.get('reason') or 'Official universe coverage'}; data generated from Yahoo fundamentals and SEC companyfacts. Review SBC tags before treating as fully audited."
    lines = [
