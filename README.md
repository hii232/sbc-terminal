...
Removed as noise (2026-07): the Stocktwits Social Buzz desk, the hardcoded-snapshot Inflation Desk, the Narratives view (including Polymarket odds), and the Options Desk trade tickets. Bundled per-name IV/RV/put-call data remains an input to Direction Edge.
