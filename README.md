...
Owner-earnings stock terminal for a fixed 60-company universe. The app is static HTML/CSS/JS and is published with GitHub Pages.
...
The terminal intentionally covers exactly 60 stocks. The source of truth is `data/universe.json` and `universe.js`, generated by:

```bash
python scripts/build_universe.py
```

Builds and tests fail if the universe is 59, 61, duplicated, missing CIK mappings, or contains an unapproved ticker. FLUT is not part of the current 60-stock universe.
